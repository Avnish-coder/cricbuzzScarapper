...
// this will fetch your data in single browser for every player
...
fs.writeFileSync("SinglePage.json", JSON.stringify(carrerData) ); // store the carrer data in the carrer.json and make data object to stringify by the JSON.stringify
